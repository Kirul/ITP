...
<html>
    ...
    <body>
        ...
        <%
            if(request.getParameter("btnAdd")!=null){
                ...
                qry="INSERT INTO placeam(eid,ename,type,gender,date,time) VALUES (?,?,?,?,?,?)";
                ...
                pstmt.executeUpdate();
                response.sendRedirect("./PlaceTheStudentsAM1.jsp");
  ...
  <section class="A">
      ...
      <article>
        ...
        <form id="addForm" action="PlaceTheStudentsAM.jsp" method="POST" name="" onsubmit="">
