        ...
        <%
         conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/university","root","");
            ...
            if(request.getParameter("btnUpd")!= null){
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/university","root","");
                qry="INSERT INTO placesff(eid,ename,type,gender,date,time,place,sid,faculty,record) VALUES (?,?,?,?,?,?,?,?,?,?)";
                ...
                pstmt.executeUpdate();
                response.sendRedirect("./PlaceTheStudentsFF2.jsp");
            ...
            if(request.getParameter("id")!=null && request.getParameter("id") != ""){
                ...
                try {
                    Class.forName("com.mysql.jdbc.Driver");
                    qry="SELECT * FROM placeff WHERE eid =?";
                    pstmt = conn.prepareStatement(qry);
                    pstmt.setInt(1, eid);
                ...
                response.sendRedirect("./PlaceTheStudentsFF3.jsp");
            }
