        ...
        <table border="1" cellspacing="5" cellpadding="4" style="border-style:solid;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="UpdatePlaceTheStudentsFM3.jsp?id=<%=eid%>">Update</a></td>
                    <td><a href="DeletePlaceTheStudentsFM3.jsp?id=<%=eid%>" onclick="return confirm('Are you Sure?')">Delete</a></td>
                </tr>
                <%
                    }
                %> 
