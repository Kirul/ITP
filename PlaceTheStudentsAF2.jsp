        ...
        <%
         conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/university","root","");
            ...
            if(request.getParameter("btnUpd")!= null){
                ...
                conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/university","root","");
                qry="INSERT INTO placesaf(eid,ename,type,gender,date,time,place,sid,faculty,record) VALUES (?,?,?,?,?,?,?,?,?,?)";
                ...
                pstmt.executeUpdate();
                response.sendRedirect("./PlaceTheStudentsAF2.jsp");
            ...
            if(request.getParameter("id")!=null && request.getParameter("id") != ""){
                ...
                response.sendRedirect("./PlaceTheStudentsAF3.jsp");
            }
