        ...
        <table border="1" cellspacing="5" cellpadding="4" style="border-style:solid;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="UpdatePlaceTheStudentsFF3.jsp?id=<%=eid%>">Update</a></td>
                    <td><a href="DeletePlaceTheStudentsFF3.jsp?id=<%=eid%>" onclick="return confirm('Are you Sure?')">Delete</a></td>
                </tr>
                <%
                    }
                %> 
...
<a href="CAhomeRecorder.jsp"><button>Home</button></a><br><br>
        <a href="PlaceTheStudentsAF1.jsp"><button>Go Back</button></a><br><br>
