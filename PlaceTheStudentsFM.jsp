...
<html>
    ...
    <body>
        ...
        <%
            if(request.getParameter("btnAdd")!=null){
                ...
                qry="INSERT INTO placefm(eid,ename,type,gender,date,time) VALUES (?,?,?,?,?,?)";
                ...
                pstmt.executeUpdate();
                response.sendRedirect("./PlaceTheStudentsFM1.jsp");
  ...
  <section class="A">
      ...
      <article>
        ...
        <form id="addForm" action="PlaceTheStudentsFM.jsp" method="POST" name="" onsubmit="">
