...
<html>
   ...
   <!-- part with logo and login-->
    ...
    <center>
        ...
        <table border="1" cellspacing="5" cellpadding="4" style="border-style:solid;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="UpdatePlaceTheStudentsAM3.jsp?id=<%=eid%>">Update</a></td>
                    <td><a href="DeletePlaceTheStudentsAM3.jsp?id=<%=eid%>" onclick="return confirm('Are you Sure?')">Delete</a></td>
                </tr>
                <%
                    }
                %> 
        ...
        <a href="PlaceTheStudentsAM1.jsp"><button>Go Back</button></a><br><br>
