        ...
        <table border="1" cellspacing="5" cellpadding="4" style="border-style:solid;">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="PlaceTheStudentsAM2.jsp?id=<%=eid%>">Place the Students</a></td>
                </tr>
                <%
                    }
                %> 
                        ...
                        <a href="PlaceTheStudentsAM.jsp"><button>Add Another event</button></a><br><br>
