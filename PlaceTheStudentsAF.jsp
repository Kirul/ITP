...
<html>
    ...
    <body>
        ...
        <%
            if(request.getParameter("btnAdd")!=null){
                ...
                qry="INSERT INTO placeaf(eid,ename,type,gender,date,time) VALUES (?,?,?,?,?,?)";
                ...
                pstmt.executeUpdate();
                response.sendRedirect("./PlaceTheStudentsAF1.jsp");
  ...
  <section class="A">
      ...
      <article>
        ...
        <form id="addForm" action="PlaceTheStudentsAF.jsp" method="POST" name="" onsubmit="">
            ...
            <table border="0" cellspacing="5" cellpadding="5"> 
                <tbody>
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" name="type" value="Annual" checked >Annual
                        
                        <input type="checkbox" name="type" value="freshers">Freshers</td>
                    </tr>
