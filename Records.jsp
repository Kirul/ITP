...
<html>
    ...
    <img src="pictures/mainHeader.png" width="100%" height="20%">
            ...
            <%
                try{
                    ...
                    <tr>
                        ...
                        <td align="center"><%=resultSet.getString("date")%></td>
        ...
        <a href="InsertRecords.jsp"><button>Insert Records</button></a><br><br>
        <a href="DeleteRecords.jsp"><button>Delete Records</button></a><br><br>
        <a href="UpdateRecords.jsp"><button>Update Records</button></a><br><br><br><br>
